...
function PassengerInfoPanel({
    ...
    const MessageConstructor = () => {
        ...
        if (adult === 0 && child === 0) {
            ...
            message = `${adult} Adult${adult > 1 ? "s" : ""}, ${child} Child${child > 1 ? "ren" : ""}`;
        }
        if (infant > 0) {
    ...
    return (
        ...
        >
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <Button
                        content={
                            <CiCirclePlus
                                size={32}
                                className={`${infant >= adult || infant >= 2 ? "text-gray-200" : ""}`}
                            />
                        }
                        variant="Icon"
                        size={"roundedFull"}
            ...
            <div className="flex-col justify-between items-center space-y-2">
                <h1 className={`${adultError ? "font-bold text-red-500" : "font-medium"}`}>
                    Maximum 7 travelers not including infants.
                </h1>
                <h1 className={`${childError ? "font-bold text-red-500" : "font-medium"}`}>
                    Maximum 3 children without an adult.
                </h1>
                <h1 className={`${infantError ? "font-bold text-red-500" : "font-medium"}`}>
